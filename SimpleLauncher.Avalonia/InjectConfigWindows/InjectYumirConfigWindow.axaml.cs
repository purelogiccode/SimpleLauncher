...
public partial class InjectYumirConfigWindow : Window
{
    ...
    public InjectYumirConfigWindow(InjectYumirConfigViewModel viewModel, IFilePickerService filePicker)
    {
        InitializeComponent();
    ...
    private async Task<string?> OnRequestEmulatorPath()
    {
        return await _filePicker.OpenFileAsync(
            "Select Yumir Emulator",
            ExecutableFileFilter.ForNamedExecutable("Yumir Executable", "ymir.exe"));
    }
}