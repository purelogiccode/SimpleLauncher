...
public partial class InjectSegaModel2ConfigWindow : Window
{
    ...
    public InjectSegaModel2ConfigWindow(InjectSegaModel2ConfigViewModel viewModel, IFilePickerService filePicker)
    {
        InitializeComponent();
    ...
    private async Task<string?> OnRequestEmulatorPath()
    {
        return await _filePicker.OpenFileAsync(
            ...
            ExecutableFileFilter.ForNamedExecutable("SEGA Model 2 Executable", "emulator.exe"));
    }
}