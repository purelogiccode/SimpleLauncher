...
public partial class InjectSupermodelConfigWindow : Window
{
    ...
    public InjectSupermodelConfigWindow(InjectSupermodelConfigViewModel viewModel, IFilePickerService filePicker)
    {
        InitializeComponent();
    ...
    private async Task<string?> OnRequestEmulatorPath()
    {
        return await _filePicker.OpenFileAsync(
            "Select Supermodel Emulator",
            ExecutableFileFilter.ForNamedExecutable("Supermodel Executable", "Supermodel.exe"));
    }
}