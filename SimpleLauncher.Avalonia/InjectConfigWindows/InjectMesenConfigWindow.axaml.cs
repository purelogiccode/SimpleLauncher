...
public partial class InjectMesenConfigWindow : Window
{
    ...
    public InjectMesenConfigWindow(InjectMesenConfigViewModel viewModel, IFilePickerService filePicker)
    {
        InitializeComponent();
    ...
    private async Task<string?> OnRequestEmulatorPath()
    {
        return await _filePicker.OpenFileAsync(
            "Select Mesen Emulator",
            ExecutableFileFilter.ForNamedExecutable("Mesen Executable", "Mesen.exe"));
    }
}