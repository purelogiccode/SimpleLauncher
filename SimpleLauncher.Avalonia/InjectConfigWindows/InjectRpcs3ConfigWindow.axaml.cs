...
public partial class InjectRpcs3ConfigWindow : Window
{
    ...
    public InjectRpcs3ConfigWindow(InjectRpcs3ConfigViewModel viewModel, IFilePickerService filePicker)
    {
        InitializeComponent();
    ...
    private async Task<string?> OnRequestEmulatorPath()
    {
        return await _filePicker.OpenFileAsync(
            "Select RPCS3 Emulator",
            ExecutableFileFilter.ForNamedExecutable("RPCS3 Executable", "rpcs3.exe"));
    }
}