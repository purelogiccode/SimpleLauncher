...
public partial class InjectStellaConfigWindow : Window
{
    ...
    public InjectStellaConfigWindow(InjectStellaConfigViewModel viewModel, IFilePickerService filePicker)
    {
        InitializeComponent();
    ...
    private async Task<string?> OnRequestEmulatorPath()
    {
        return await _filePicker.OpenFileAsync(
            "Select Stella Emulator",
            ExecutableFileFilter.ForNamedExecutable("Stella Executable", "stella.exe"));
    }
}