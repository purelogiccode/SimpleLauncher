...
public partial class InjectDuckStationConfigWindow : Window
{
    ...
    public InjectDuckStationConfigWindow(InjectDuckStationConfigViewModel viewModel, IFilePickerService filePicker)
    {
        InitializeComponent();
    ...
    private async Task<string?> OnRequestEmulatorPath()
    {
        return await _filePicker.OpenFileAsync(
            ...
            ExecutableFileFilter.ForNamedExecutable("DuckStation Executable", "duckstation*.exe"));
    }
}