...
public partial class InjectRetroArchConfigWindow : Window
{
    ...
    public InjectRetroArchConfigWindow(InjectRetroArchConfigViewModel viewModel, IFilePickerService filePicker)
    {
        InitializeComponent();
    ...
    private async Task<string?> OnRequestEmulatorPath()
    {
        return await _filePicker.OpenFileAsync(
            "Select RetroArch Emulator",
            ExecutableFileFilter.ForNamedExecutable("RetroArch Executable", "retroarch.exe"));
    }
}