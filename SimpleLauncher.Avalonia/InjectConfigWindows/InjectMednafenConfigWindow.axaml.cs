...
public partial class InjectMednafenConfigWindow : Window
{
    ...
    public InjectMednafenConfigWindow(InjectMednafenConfigViewModel viewModel, IFilePickerService filePicker)
    {
        InitializeComponent();
    ...
    private async Task<string?> OnRequestEmulatorPath()
    {
        return await _filePicker.OpenFileAsync(
            "Select Mednafen Emulator",
            ExecutableFileFilter.ForNamedExecutable("Mednafen Executable", "mednafen.exe"));
    }
}