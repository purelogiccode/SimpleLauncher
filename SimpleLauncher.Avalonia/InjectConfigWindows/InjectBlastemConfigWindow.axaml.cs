...
/// <summary>
///     Window for injecting Blastem emulator configuration settings.
/// </summary>
public partial class InjectBlastemConfigWindow : Window
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="InjectBlastemConfigWindow" /> class.
    /// </summary>
    ...
    public InjectBlastemConfigWindow(InjectBlastemConfigViewModel viewModel, IFilePickerService filePicker)
    {
        InitializeComponent();
    ...
    /// </summary>
    /// <param name="emulatorPath">Optional path to the Blastem emulator executable.</param>
    ...
    private async Task<string?> OnRequestEmulatorPath()
    {
        return await _filePicker.OpenFileAsync(
            "Select Blastem Emulator",
            ExecutableFileFilter.ForNamedExecutable("Blastem Executable", "blastem.exe"));
    }
}